from django.views.generic import TemplateView, CreateView, UpdateView, ListView, DeleteView, DetailView, View
...
#         context["news_qs"] = mainapp_models.News.objects.all()[:10]
#         return context
